...
<div id="wrapper"> 
  ...
  <div id="page_content">
    <div class="left_section">
      <div class="common_content">
        <h2>CHOOSE A JOB</h2>
		<p>This section is to view candidates who apply selected job. </p>
		...
		?>
		<form action="listedjobs.php" method="POST">	
		
		<p>Please Choose a Job:<p>
		<select name="listedjob">
  ...
  <?php
	...
	<br><input type="submit" name="submit" value="Submit" style="width: 22em; margin-left:-2px; !important "/>
</form>
        <p> </p>
           <hr>
      </div>
