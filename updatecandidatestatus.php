  ...
  <div id="page_content">
    <div class="left_section">
      <div class="common_content">
        <h2>Update Candidate Acceptance Status</h2>
		<p>In this section you can change candidate acceptance situation.<br>First you need to choose which candidate status wants to be changed.</p>
<?php
	
	
	include 'databaseconnection.php';
	$query = $conn->prepare("SELECT * FROM `applied_cands`");
	$query->execute();
	

	?>
	<form action="updatecandstat.php" method="post">
