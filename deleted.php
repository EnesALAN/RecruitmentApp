  ...
  <div id="page_content">
    <div class="left_section">
      <div class="common_content">
        <h2>DELETED CANDIDATE</h2>
		<p>Deleted Candidate information is shown below.</p>
		<?php
...
$query7 = $conn->prepare("DELETE FROM `candidate_experience` WHERE cand_id='$choice'");
$query7->execute();
$query6 = $conn->prepare("DELETE FROM `candidate_skills` WHERE cand_id='$choice'");
$query6->execute();
$query5 = $conn->prepare("DELETE FROM `job_enrollment` WHERE cand_id='$choice'");
$query5->execute();
$query4 = $conn->prepare("DELETE FROM `candlogin` WHERE canduser_id='$choice'");
$query4->execute();
$query3 = $conn->prepare("DELETE FROM `candidate_languages` WHERE cand_id='$choice'");
$query3->execute();
$query2 = $conn->prepare("DELETE FROM `candidates2` WHERE candidateID='$choice'");
$query2->execute();
?>
        <p> </p>
           <hr>
