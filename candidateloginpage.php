  ...
  <div id="page_content">
    <div class="left_section">
	  ...
	  <h1>Dear Candidate</h1>
		...
		<form action="candloginresult.php" method="POST">	
		ID number:<br>
		<input type="text" name="username" class="login"><br>
		Password:<br>
		<input type="password" name="password" required class="login"><br><br>
		<input type="submit" name="submit" id="submit" value="Login" class="login"/>
		</form>
